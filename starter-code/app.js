...
//      Arrow functions do not bind their own this.  Instead, they get the info from the parent scope.  Since the first function did not use an arrow, it was able to use this and get the info from the nearby function.  Using this with an arrow function gets nothing so it pulls the next best thing, which is the window.
